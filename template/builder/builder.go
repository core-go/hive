...
import (
	...
	tem "github.com/core-go/hive/template"
)
...
func UseQuery[F any](id string, m map[string]*tem.Template, modelType *reflect.Type, mp func(interface{}, *reflect.Type, ...func(string, reflect.Type) string) map[string]interface{}, param func(i int) string, buildSort func(string, reflect.Type) string, opts ...func(string) string) (func(F) string, error) {
...
func GetQuery[F any](isTemplate bool, query func(F) (string, []interface{}), id string, m map[string]*tem.Template, modelType *reflect.Type, mp func(interface{}, *reflect.Type, ...func(string, reflect.Type) string) map[string]interface{}, param func(i int) string, buildSort func(string, reflect.Type) string, opts ...func(string) string) (func(F) string, error) {
	if !isTemplate {
		return query, nil
	}
	b, err := NewQueryBuilder[F](id, m, modelType, mp, param, buildSort, opts...)
...
func (b *QueryBuilder[F]) BuildQuery(f F) string {
